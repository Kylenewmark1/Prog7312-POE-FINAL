    ...
    public partial class FindingCallNumbers : Form
    {
        ...
        private void FindingCallNumbers_Load(object sender, EventArgs e)
        {
            ...
            #region Show Instructions
                    {
                // quiz instructions
                MessageBox.Show("Welcome to the Finding Call Numbers Quiz!\n\n" +
                    "In this quiz, you'll explore the Dewey Decimal classification system by drilling deeper into the hierarchy.\n\n" +
                    "Instructions:\n" +
                    "1. Choose 'Finding Call Numbers' from the menu.\n" +
                    "2. The application will load Dewey Decimal classification data.\n" +
                    "3. A third-level entry, e.g., '752 Color,' will be randomly selected.\n" +
                    "4. You'll see four top-level options; one is correct, the others are incorrect.\n" +
                    "   Example:\n" +
                    "   - 000 General\n" +
                    "   - 400 Language\n" +
                    "   - 700 Arts & Recreation (Correct answer)\n" +
                    "   - 800 Literature\n" +
                    "5. Choose the correct top-level option.\n" +
                    "6. If correct, the quiz progresses to the next level; if wrong, try again.\n" +
                    "7. Repeat until the most detailed level is reached.\n" +
                    "8. Continue answering questions to explore the hierarchy.\n\n" +
                    "Enjoy the quiz and have fun exploring the Dewey Decimal system!", "Finding Call Numbers Quiz - Instructions");
            }
            #endregion
