...
namespace DeweyDecimalLibrary.Tree_Structure
{
    public class MakeTree
    {
        public static Tree<DeweyPair> GrowATree()
        {
            ...
            lstLevel1.Add(new DeweyPair { Number = "900", Description = "History and Geography" });
            ...
            List<DeweyPair> l900 = HistoryAndGeography();
            ...
            lstPair.AddChildren(l900, lstLevel1[8]);
            #endregion
        ...
        public static List<DeweyPair> HistoryAndGeography()
        {
            // instantiate list object
            List<DeweyPair> lstPairs = new List<DeweyPair>();

            // populate the list
            lstPairs.Add(new DeweyPair { Number = "910", Description = "Geography and Travel" });
            lstPairs.Add(new DeweyPair { Number = "920", Description = "Biography, Genealogy, Insignia" });
            lstPairs.Add(new DeweyPair { Number = "930", Description = "History of the Ancient World" });
